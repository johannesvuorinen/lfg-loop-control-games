...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(e,t,n){let r=new Float32Array(ao),i=new K(0,1,0);return new zi({name:`SphericalGaussianBlur`,defines:{n:ao,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Co(),fragmentShader:`
	...
	`}var wo=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ys={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Xs(e,t){let n=Ys[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Zs=new K;function Qs(){return J.getLuminanceCoefficients(Zs),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Zs.x.toFixed(4)}, ${Zs.y.toFixed(4)}, ${Zs.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},ul=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},dl=new Sa(-1,1,1,-1,0,1),fl=new class extends wr{constructor(){super(),this.setAttribute(`position`,new X([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new X([0,2,0,0,2,0],2))}},pl=class{constructor(e){this._mesh=new qr(fl,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,dl)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},ml=class extends ul{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof zi?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=Ii.clone(e.uniforms),this.material=new zi({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new pl(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},hl=class extends ul{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},gl=class extends ul{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},_l=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new G);this._width=n.width,this._height=n.height,t=new Wt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:g}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new ml(ll),this.copyPass.material.blending=0,this.timer=new ka}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}hl!==void 0&&(r instanceof hl?n=!0:r instanceof gl&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new G);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},vl=class extends ul{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new Y}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},yl={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new Y(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}_getCompositeMaterial(e){return new zi({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};bl.BlurDirectionX=new G(1,0),bl.BlurDirectionY=new G(0,1);var xl={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Sl=class extends ul{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ii.clone(xl.uniforms),this.material=new Bi({name:xl.name,uniforms:this.uniforms,vertexShader:xl.vertexShader,fragmentShader:xl.fragmentShader}),this._fsQuad=new pl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},$=e=>new Y(e),Cl=[{t:0,sunColor:$(16769704),sunIntensity:2.6,skyTop:$(4880584),skyBottom:$(15976843),hemiSky:$(10273023),hemiGround:$(7035454),hemiIntensity:.85,fogColor:$(15118967),fogDensity:.004,sunElevation:wt.degToRad(40)},{t:.35,sunColor:$(16757082),sunIntensity:2.2,skyTop:$(4153254),skyBottom:$(15771742),hemiSky:$(8955624),hemiGround:$(6965808),hemiIntensity:.7,fogColor:$(14653013),fogDensity:.0065,sunElevation:wt.degToRad(16)},{t:.6,sunColor:$(16743994),sunIntensity:1.7,skyTop:$(2899846),skyBottom:$(14840122),hemiSky:$(6715592),hemiGround:$(5190690),hemiIntensity:.5,fogColor:$(12083e3),fogDensity:.011,sunElevation:wt.degToRad(2)},{t:.8,sunColor:$(9060170),sunIntensity:.55,skyTop:$(1778774),skyBottom:$(7027290),hemiSky:$(3820166),hemiGround:$(2629427),hemiIntensity:.32,fogColor:$(4862804),fogDensity:.018,sunElevation:wt.degToRad(-8)},{t:1,sunColor:$(2371676),sunIntensity:.12,skyTop:$(329231),skyBottom:$(791088),hemiSky:$(1317952),hemiGround:$(526870),hemiIntensity:.16,fogColor:$(527132),fogDensity:.03,sunElevation:wt.degToRad(-22)}],wl=new Y,Tl=new Y;function El(e){return e*e*(3-2*e)}var Dl=class{sun;hemi;scene;skyMat;sky;sunColor=new Y;skyTop=new Y;skyBottom=new Y;fogColor=new Y;constructor(e){this.scene=e,this.sun=new wa(16777215,2.6),this.sun.castShadow=!0,this.sun.shadow.mapSize.set(2048,2048);let t=this.sun.shadow.camera;t.near=1,t.far=120,t.left=-45,t.right=45,t.top=45,t.bottom=-45,this.sun.shadow.bias=-6e-4,this.sun.shadow.normalBias=.04,e.add(this.sun),e.add(this.sun.target),this.hemi=new sa(10273023,7035454,.85),e.add(this.hemi),e.fog=new An(15118967,.004),this.skyMat=new zi({side:1,depthWrite:!1,uniforms:{topColor:{value:new Y(4880584)},bottomColor:{value:new Y(15976843)},offset:{value:8},exponent:{value:.7}},vertexShader:`
      ...
      `}),this.sky=new qr(new Ai(400,32,16),this.skyMat),this.sky.renderOrder=-1,e.add(this.sky),this.apply(0)}apply(e){e=wt.clamp(e,0,1);let t=0;for(;t<Cl.length-1&&e>Cl[t+1].t;)t++;let n=Cl[t],r=Cl[Math.min(t+1,Cl.length-1)],i=r.t-n.t||1,a=El(wt.clamp((e-n.t)/i,0,1)),o=wt.lerp(n.sunElevation,r.sunElevation,a),s=wt.lerp(-.5,.85,e),c=Math.cos(o);this.sun.position.set(Math.sin(s)*c*60,Math.sin(o)*60,Math.cos(s)*c*60),this.sun.target.position.set(0,0,0),this.sun.target.updateMatrixWorld(),this.sunColor.copy(wl.copy(n.sunColor)).lerp(Tl.copy(r.sunColor),a),this.sun.color.copy(this.sunColor),this.sun.intensity=wt.lerp(n.sunIntensity,r.sunIntensity,a),this.hemi.color.copy(wl.copy(n.hemiSky)).lerp(Tl.copy(r.hemiSky),a),this.hemi.groundColor.copy(wl.copy(n.hemiGround)).lerp(Tl.copy(r.hemiGround),a),this.hemi.intensity=wt.lerp(n.hemiIntensity,r.hemiIntensity,a),this.fogColor.copy(wl.copy(n.fogColor)).lerp(Tl.copy(r.fogColor),a);let l=this.scene.fog;return l.color.copy(this.fogColor),l.density=wt.lerp(n.fogDensity,r.fogDensity,a),this.skyTop.copy(wl.copy(n.skyTop)).lerp(Tl.copy(r.skyTop),a),this.skyBottom.copy(wl.copy(n.skyBottom)).lerp(Tl.copy(r.skyBottom),a),this.skyMat.uniforms.topColor.value.copy(this.skyTop),this.skyMat.uniforms.bottomColor.value.copy(this.skyBottom),{t:e,phase:Ol(e)}}dispose(){this.sky.geometry.dispose(),this.skyMat.dispose(),this.sun.dispose(),this.hemi.dispose()}};function Ol(e){return e<.3?`Golden hour`:e<.55?`Late afternoon`:e<.72?`Sunset`:e<.9?`Dusk`:`Nightfall`}var kl=class{root=new Sn;player;beacons=[];obstacles=[];disposables=[];constructor(){this.buildGround(),this.buildObstacles(),this.buildBeacons(),this.player=this.buildPlayer(),this.root.add(this.player)}track(e){return this.disposables.push(e),e}buildGround(){let e=new qr(this.track(new wi(48,64)),this.track(new Vi({color:3951157,roughness:.95,metalness:0})));e.rotation.x=-Math.PI/2,e.receiveShadow=!0,this.root.add(e);let t=new Ua(84,28,2107952,2107952);t.material.opacity=.25,t.material.transparent=!0,t.position.y=.02,this.root.add(t),this.disposables.push(t.geometry,t.material)}buildObstacles(){let e=Al(1337),t=this.track(new Di(1,0)),n=this.track(new Si(1,1,1)),r=this.track(new Vi({color:5200466,roughness:1,flatShading:!0})),i=this.track(new Vi({color:5918532,roughness:.85}));for(let a=0;a<18;a++){let a=e()*Math.PI*2,o=8+e()*33,s=Math.cos(a)*o,c=Math.sin(a)*o,l=e()>.45,u=1.1+e()*2.4,d=new qr(l?t:n,l?r:i);d.position.set(s,l?u*.4:u*.5,c),d.scale.setScalar(l?u:u*.8),l||(d.scale.y*=1+e()*1.6,d.position.y=d.scale.y*.5),d.rotation.y=e()*Math.PI,d.castShadow=!0,d.receiveShadow=!0,this.root.add(d),this.obstacles.push({pos:new G(s,c),r:u*.7})}}buildBeacons(){let e=this.track(new Ti(1.1,1.4,.6,8)),t=this.track(new Ti(.5,.7,5,8)),n=this.track(new Oi(.9,0)),r=this.track(new Vi({color:7040890,roughness:.8}));for(let i=0;i<5;i++){let a=i/5*Math.PI*2+.4,o=42*.74,s=Math.cos(a)*o,c=Math.sin(a)*o,l=new Sn;l.position.set(s,0,c);let u=new qr(e,r);u.position.y=.3,u.castShadow=!0,u.receiveShadow=!0;let d=new qr(t,r);d.position.y=3.1,d.castShadow=!0;let f=this.track(new Vi({color:2240580,emissive:658966,emissiveIntensity:1,roughness:.25,metalness:.1})),p=new qr(n,f);p.position.y=6.3,p.castShadow=!0;let m=new xa(16763e3,0,26,2);m.position.copy(p.position),l.add(u,d,p,m),this.root.add(l),this.beacons.push({group:l,light:m,crystal:p,crystalMat:f,lit:!1,pos:new G(s,c)})}}buildPlayer(){let e=new Sn,t=new qr(this.track(new Ci(.5,1,6,12)),this.track(new Vi({color:14673919,emissive:2767466,emissiveIntensity:.6,roughness:.4,metalness:.1})));t.position.y=1,t.castShadow=!0,e.add(t);let n=new xa(10469631,1.1,12,2);return n.position.set(0,1.4,0),e.add(n),e.position.set(0,0,0),e}lightBeacon(e){e.lit=!0,e.crystalMat.color.set(16773312),e.crystalMat.emissive.set(16757325),e.crystalMat.emissiveIntensity=3.2,e.light.intensity=24}dispose(){for(let e of this.disposables)e.dispose();this.disposables.length=0}};function Al(e){let t=e>>>0;return function(){t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var jl=class{phase=document.getElementById(`phase`);clockfill=document.getElementById(`clockfill`);beacons=document.getElementById(`beacons`);banner=document.getElementById(`banner`);bannerTitle=document.getElementById(`banner-title`);bannerSub=document.getElementById(`banner-sub`);setTime(e,t){this.phase.textContent=t,this.clockfill.style.width=`${Math.round(e*100)}%`}setBeacons(e,t){this.beacons.textContent=`${e} / ${t}`}showBanner(e,t,n){this.banner.className=`show ${e}`,this.bannerTitle.textContent=t,this.bannerSub.textContent=n}hideBanner(){this.banner.className=``}},Ml=60,Nl=14,Pl=2.4,Fl=document.getElementById(`app`),Il=new cl({antialias:!0,powerPreference:`high-performance`});Il.setPixelRatio(Math.min(window.devicePixelRatio,2)),Il.setSize(window.innerWidth,window.innerHeight),Il.shadowMap.enabled=!0,Il.shadowMap.type=1,Il.toneMapping=4,Il.toneMappingExposure=1.05,Fl.appendChild(Il.domElement);var Ll=new jn,Rl=new ya(55,window.innerWidth/window.innerHeight,.1,1e3),zl=new _l(Il);zl.addPass(new vl(Ll,Rl));var Bl=new bl(new G(window.innerWidth,window.innerHeight),.7,.6,.85);zl.addPass(Bl),zl.addPass(new Sl);var Vl=new jl,Hl,Ul,Wl=0,Gl=`playing`,Kl=!1;function ql(){Ul&&(Ll.remove(Ul.root),Ul.dispose()),Hl&&(Ll.remove(Hl.sky),Hl.dispose()),Hl=new Dl(Ll),Ul=new kl,Ll.add(Ul.root),Wl=0,Gl=`playing`,Kl=!1,eu=!1,Vl.hideBanner(),Vl.setBeacons(0,Ul.beacons.length),Hl.apply(0)}var Jl=new Set;window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();if(t===`r`){ql();return}Jl.add(t)}),window.addEventListener(`keyup`,e=>Jl.delete(e.key.toLowerCase()));function Yl(){let e=0,t=0;(Jl.has(`w`)||Jl.has(`arrowup`))&&--t,(Jl.has(`s`)||Jl.has(`arrowdown`))&&(t+=1),(Jl.has(`a`)||Jl.has(`arrowleft`))&&--e,(Jl.has(`d`)||Jl.has(`arrowright`))&&(e+=1);let n=new G(e,t);return n.lengthSq()>0&&n.normalize(),n}var Xl=new G;function Zl(e,t,n,r){Xl.set(e+n,t+r),Xl.length()>45&&Xl.setLength(45);for(let e of Ul.obstacles){let t=e.r+.6,n=Xl.distanceTo(e.pos);n<t&&n>1e-4&&Xl.sub(e.pos).setLength(t).add(e.pos)}return Xl}var Ql=new K(0,16,22),$l=new K,eu=!1;function tu(e){if(eu)return;let t=Ul.player.position;$l.copy(t).add(Ql),Rl.position.lerp($l,1-.0015**e),Rl.lookAt(t.x,t.y+1.5,t.z)}var nu=new ka;function ru(){let e=0;for(let t of Ul.beacons)t.lit&&e++;return e}function iu(){let e=Ul.player.position;for(let t of Ul.beacons){if(t.lit)continue;let n=e.x-t.pos.x,r=e.z-t.pos.y;n*n+r*r<Pl*Pl&&Ul.lightBeacon(t)}}function au(){nu.update();let e=Math.min(nu.getDelta(),.05);if(Gl===`playing`&&!Kl){Wl+=e;let t=Wl/Ml,n=Hl.apply(t);Vl.setTime(n.t,n.phase);let r=Yl();if(r.lengthSq()>0){let t=Ul.player.position,n=Zl(t.x,t.z,r.x*Nl*e,r.y*Nl*e);Ul.player.position.set(n.x,0,n.y),Ul.player.rotation.y=Math.atan2(r.x,r.y)}iu();let i=ru();Vl.setBeacons(i,Ul.beacons.length),i===Ul.beacons.length?(Gl=`win`,Vl.showBanner(`win`,`DAYLIGHT SAVED`,`All beacons lit before dark · press R to run again`)):t>=1&&(Gl=`lose`,Vl.showBanner(`lose`,`NIGHTFALL`,`${i}/${Ul.beacons.length} beacons lit · press R to retry`))}tu(e),zl.render(),requestAnimationFrame(au)}window.addEventListener(`resize`,()=>{let e=window.innerWidth,t=window.innerHeight;Rl.aspect=e/t,Rl.updateProjectionMatrix(),Il.setSize(e,t),zl.setSize(e,t),Bl.setSize(e,t)}),window.__dusk={setTime(e,t=!1){Wl=e*Ml;let n=Hl.apply(e);Vl.setTime(n.t,n.phase),Kl=t},lightBeacons(e){let t=0;for(let n of Ul.beacons){if(t>=e)break;Ul.lightBeacon(n),t++}Vl.setBeacons(ru(),Ul.beacons.length)},placePlayer(e,t){Ul.player.position.set(e,0,t)},lookFrom(e,t){eu=!0,Rl.position.set(e[0],e[1],e[2]),Rl.lookAt(t[0],t[1],t[2])}},ql(),Rl.position.copy(Ul.player.position).add(Ql),au();